...
const fixtureRoot = resolve(projectRoot, 'test-fixtures', 'osm2streets');
const vendorRoot = resolve(projectRoot, 'vendor', 'osm2streets-js');
const osm2streetsRoot = resolve(projectRoot, 'vendor', 'osm2streets');
const outputRoot = resolve(projectRoot, 'test-output', 'osm2streets-comparison');

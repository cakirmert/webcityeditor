...
const catalog = {
  ...
  summary: {
    ...
    features: summary.totals.roads + (summary.totals.intersections ?? 0),
    cityObjects: summary.totals.roads + (summary.totals.intersections ?? 0),
    roads: summary.totals.roads,
    intersections: summary.totals.intersections ?? 0,

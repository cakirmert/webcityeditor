...
export default defineConfig({
  ...
  optimizeDeps: {
    // The repository root also contains the osm2streets source submodule.
    // Scan only the editor entry instead of treating the submodule demos as
    // additional Vite applications.
    entries: ['index.html'],
